...
<div class="container">
    ...
    <a href="{{ route('jefe.grupos.create') }}" class="btn btn-primary mb-3">
        Crear Nuevo Grupo
    </a>
    ...
    <table class="table table-bordered table-striped">
        ...
        @foreach($grupos as $grupo)
            <tr>
                ...
                {{-- Acciones --}}
                <td>
                    <a href="{{ route('jefe.grupos.edit', $grupo->id) }}" class="btn btn-warning btn-sm">Editar</a>

                    <form action="{{ route('jefe.grupos.destroy', $grupo->id) }}" method="POST" style="display:inline-block;">
                        @csrf
                        @method('DELETE')
