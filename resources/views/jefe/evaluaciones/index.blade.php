    ...
    <div class="card shadow-lg border-0 rounded-4">
        <div class="card-body p-4">
            ...
            <p class="text-muted mb-4">
                Aquí puedes consultar todas las evaluaciones realizadas por los alumnos.
                <br>
                <strong class="text-dark">El nombre del alumno está oculto</strong> por motivos de privacidad.
            </p>
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle text-center shadow-sm rounded-3 overflow-hidden">
                    <thead class="table-primary">
                        <tr>
                            <th><i class="bi bi-person-vcard"></i> Maestro</th>
                          
                            <th><i class="bi bi-star-fill"></i> Calificación</th>
                            <th><i class="bi bi-chat-dots"></i> Comentarios</th>
                    ...
                    <tbody>
                        @foreach ($evaluaciones as $eva)
                            <tr class="table-row-hover">
                                ...
                                <td>
                                    <span class="badge bg-success fs-6 py-2 px-3 shadow-sm rounded-pill">
                                        ★ {{ $eva->calificacion }}
                                    </span>
                                </td>
